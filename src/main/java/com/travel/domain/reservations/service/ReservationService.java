...
public class ReservationService {
  ...
  private static final String MAIL_TEMPLATE_CONFIRMATION =
      "templates/reservation-confirmation.html";
  ...
  public ReservationHistoryListResponse getReservationHistories(Long memberId) {
    ...
    if (reservations.isEmpty()) {
      return ReservationHistoryListResponse.builder()
          .reservationHistoryList(new ArrayList<>())
          .build();
    }
  ...
  public ReservationListResponse createReservation(
      ReservationListRequest requestList, Long memberId) {
  ...
  public ReservationCancelResponse cancelReservation(
    ...
    Reservation target =
        reservationRepository.getReservationByIdAndMemberId(request.getId(), memberId);
    ...
    emailService.sendReservationConfirmation(
        member.getEmail(), target, MAIL_TEMPLATE_CANCEL, MAIL_SUBJECT_CANCEL);
  ...
  private List<ProductInfoPerNight> findProductInfoPerNightList(
      long productId, LocalDate checkInDate, LocalDate checkOutDate) {
    return productInfoPerNightRepository.findByProductIdAndDateRangeWithPessimisticLock(
